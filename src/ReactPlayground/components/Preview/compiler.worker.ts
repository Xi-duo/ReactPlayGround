...
export const beforeTransfromCode  = (filename:string,code:string)=>{
    let _code = code
...
export const babelTransfrom = (filename:string,code:string,files:Files)=>{
    const _code = beforeTransfromCode(filename,code)
    let result =  ''
    try{
